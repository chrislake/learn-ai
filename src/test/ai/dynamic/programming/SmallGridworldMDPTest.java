...
public class SmallGridworldMDPTest {
	...
	public void testDiscount10CountK0() {
		...
		for (int state_t=0; state_t<sizeS; state_t++) {
			for (int action_t=0; action_t<sizeA; action_t++) {
				Assert.assertEquals( 0.0d, markovDecisionProcess.getActionValue(state_t, action_t), 0.1d);
			}
		}
	}
	...
	public void testDiscount10CountK10() {
		markovDecisionProcess.setValueFunction(ValueFunction.BELLMAN_ITERATIVE);
		markovDecisionProcess.setValueFunctionAttempts(10);
		markovDecisionProcess.setDiscount(1.0d);
		markovDecisionProcess.restorePolicy();
		markovDecisionProcess.evaluateValueFunction();
		Assert.assertEquals( 0.0d, markovDecisionProcess.getStateValue(0), 0.1d);
		...
		Assert.assertEquals( 0.00d, markovDecisionProcess.getActionValue(0, 2), 0.01d);
		Assert.assertEquals( 0.00d, markovDecisionProcess.getActionValue(0, 3), 0.01d);
		Assert.assertEquals(-6.70d, markovDecisionProcess.getActionValue(1, 0), 0.01d);
		Assert.assertEquals(-8.16d, markovDecisionProcess.getActionValue(1, 1), 0.01d);
		Assert.assertEquals(-1.00d, markovDecisionProcess.getActionValue(1, 2), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(1, 3), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(2, 0), 0.01d);
		Assert.assertEquals(-8.78d, markovDecisionProcess.getActionValue(2, 1), 0.01d);
		Assert.assertEquals(-6.70d, markovDecisionProcess.getActionValue(2, 2), 0.01d);
		Assert.assertEquals(-9.23d, markovDecisionProcess.getActionValue(2, 3), 0.01d);
		Assert.assertEquals(-9.23d, markovDecisionProcess.getActionValue(3, 0), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(3, 1), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(3, 2), 0.01d);
		Assert.assertEquals(-9.23d, markovDecisionProcess.getActionValue(3, 3), 0.01d);
		Assert.assertEquals(-1.00d, markovDecisionProcess.getActionValue(4, 0), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(4, 1), 0.01d);
		Assert.assertEquals(-6.70d, markovDecisionProcess.getActionValue(4, 2), 0.01d);
		Assert.assertEquals(-8.16d, markovDecisionProcess.getActionValue(4, 3), 0.01d);
		Assert.assertEquals(-6.70d, markovDecisionProcess.getActionValue(5, 0), 0.01d);
		Assert.assertEquals(-8.78d, markovDecisionProcess.getActionValue(5, 1), 0.01d);
		Assert.assertEquals(-6.70d, markovDecisionProcess.getActionValue(5, 2), 0.01d);
		Assert.assertEquals(-8.78d, markovDecisionProcess.getActionValue(5, 3), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(6, 0), 0.01d);
		Assert.assertEquals(-8.16d, markovDecisionProcess.getActionValue(6, 1), 0.01d);
		Assert.assertEquals(-8.16d, markovDecisionProcess.getActionValue(6, 2), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(6, 3), 0.01d);
		Assert.assertEquals(-9.23d, markovDecisionProcess.getActionValue(7, 0), 0.01d);
		Assert.assertEquals(-6.70d, markovDecisionProcess.getActionValue(7, 1), 0.01d);
		Assert.assertEquals(-8.78d, markovDecisionProcess.getActionValue(7, 2), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(7, 3), 0.01d);
		Assert.assertEquals(-6.70d, markovDecisionProcess.getActionValue(8, 0), 0.01d);
		Assert.assertEquals(-9.23d, markovDecisionProcess.getActionValue(8, 1), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(8, 2), 0.01d);
		Assert.assertEquals(-8.78d, markovDecisionProcess.getActionValue(8, 3), 0.01d);
		Assert.assertEquals(-8.16d, markovDecisionProcess.getActionValue(9, 0), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(9, 1), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(9, 2), 0.01d);
		Assert.assertEquals(-8.16d, markovDecisionProcess.getActionValue(9, 3), 0.01d);
		Assert.assertEquals(-8.78d, markovDecisionProcess.getActionValue(10, 0), 0.01d);
		Assert.assertEquals(-6.70d, markovDecisionProcess.getActionValue(10, 1), 0.01d);
		Assert.assertEquals(-8.78d, markovDecisionProcess.getActionValue(10, 2), 0.01d);
		Assert.assertEquals(-6.70d, markovDecisionProcess.getActionValue(10, 3), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(11, 0), 0.01d);
		Assert.assertEquals(-1.00d, markovDecisionProcess.getActionValue(11, 1), 0.01d);
		Assert.assertEquals(-8.16d, markovDecisionProcess.getActionValue(11, 2), 0.01d);
		Assert.assertEquals(-6.70d, markovDecisionProcess.getActionValue(11, 3), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(12, 0), 0.01d);
		Assert.assertEquals(-9.23d, markovDecisionProcess.getActionValue(12, 1), 0.01d);
		Assert.assertEquals(-9.23d, markovDecisionProcess.getActionValue(12, 2), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(12, 3), 0.01d);
		Assert.assertEquals(-8.78d, markovDecisionProcess.getActionValue(13, 0), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(13, 1), 0.01d);
		Assert.assertEquals(-9.23d, markovDecisionProcess.getActionValue(13, 2), 0.01d);
		Assert.assertEquals(-6.70d, markovDecisionProcess.getActionValue(13, 3), 0.01d);
		Assert.assertEquals(-8.16d, markovDecisionProcess.getActionValue(14, 0), 0.01d);
		Assert.assertEquals(-6.70d, markovDecisionProcess.getActionValue(14, 1), 0.01d);
		Assert.assertEquals(-8.70d, markovDecisionProcess.getActionValue(14, 2), 0.01d);
		Assert.assertEquals(-1.00d, markovDecisionProcess.getActionValue(14, 3), 0.01d);
		Assert.assertEquals( 0.00d, markovDecisionProcess.getActionValue(15, 0), 0.01d);
		Assert.assertEquals( 0.00d, markovDecisionProcess.getActionValue(15, 1), 0.01d);
		Assert.assertEquals( 0.00d, markovDecisionProcess.getActionValue(15, 2), 0.01d);
