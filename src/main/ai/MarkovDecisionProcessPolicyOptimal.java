...
public class MarkovDecisionProcessPolicyOptimal<S, A> {
	...
	public MarkovDecisionProcessPolicyOptimal(int sizeS, int sizeA) {
		this(sizeS, sizeA, 0.0d);
	}
	public MarkovDecisionProcessPolicyOptimal(int sizeS, int sizeA, double discount) {
		this(sizeS, sizeA, discount, true);
	}
	public MarkovDecisionProcessPolicyOptimal(int sizeS, int sizeA, double discount, boolean useBellmanMatrix) {
